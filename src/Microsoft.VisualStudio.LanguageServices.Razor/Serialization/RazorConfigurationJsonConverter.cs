...
namespace Microsoft.VisualStudio.LanguageServices.Razor.Serialization
{
    internal class RazorConfigurationJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var designTime = obj[nameof(RazorConfiguration.DesignTime)].Value<bool>();
            var extensions = obj[nameof(RazorConfiguration.Extensions)].ToObject<RazorExtension[]>(serializer);

            return RazorConfiguration.Create(RazorLanguageVersion.Parse(languageVersion), configurationName, extensions, designTime);
        }
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            writer.WritePropertyName(nameof(RazorConfiguration.DesignTime));
            writer.WriteValue(configuration.DesignTime);
