...
{
    [Export(typeof(IFallbackTemplateEngineFactory))]
    internal class FallbackTemplateEngineFactory : IFallbackTemplateEngineFactory
    {
        public RazorTemplateEngine Create(RazorConfiguration configuration, RazorProject project, Action<IRazorEngineBuilder> configure)
        {
            ...
            return new RazorTemplateEngine(RazorEngine.CreateCore(configuration, configure), project);
        }
    }
}
